...
import { checkRegionsForBounty } from "../ImageCanvas/region-tools"
            ...
            <Workspace
              ...
              headerLeftSide={[
                state.annotationType === "video" ? (
                  ...
                  <div key={activeImage.name} className={classes.headerTitle}>{activeImage.name}</div>
                ) : null,
              ].filter(Boolean)}
              headerItems={[
                !hidePrev && { name: "Prev" },
              ...
              rightSidebarItems={[
                ...
                state.regionClsList && (
                  <ClassSelectionMenu
                    key={state.selectedCls}
                    regions={activeImage ? activeImage.regions : emptyArr}
                    selectedCls={state.selectedCls}
                    regionClsList={state.regionClsList}
                    onSelectCls={action("SELECT_CLASSIFICATION", "cls")}
                    checkRegionsForBounty={checkRegionsForBounty}
                  />
                ),
                state.labelImages && (
                  <TagsSidebarBox
